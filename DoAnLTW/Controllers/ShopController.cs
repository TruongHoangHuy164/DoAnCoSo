...
namespace DoAnLTW.Controllers
{
    public class ShopController : Controller
    {
        ...
        public async Task<IActionResult> SearchSuggestions(string searchString)
        {
            ...
            var products = await _context.Products
                ...
                .Select(p => new
                {
                    ...
                    name = p.Name,
                    imageUrl = p.Images.FirstOrDefault().ImageUrl ?? "/img/default-product.jpg",
        ...
        // Danh sách sản phẩm
        public async Task<IActionResult> Index(string searchTerm, int? categoryId, int? brandId, int? sizeId, decimal? minPrice, decimal? maxPrice, string sortOrder = "name")
        {
            ...
            {
                searchTerm = searchTerm.Trim().TrimEnd('.').ToLower();
        ...
        // Thêm vào danh sách yêu thích (dùng WishProductList)
        [HttpPost]
