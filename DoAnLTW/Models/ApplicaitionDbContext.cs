...
namespace DoAnLTW.Models
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Cấu hình mối quan hệ giữa Order và PromotionCode
            modelBuilder.Entity<Order>()
            ...
            modelBuilder.Entity<Pet>()
                .Property(p => p.UserId)
                .IsRequired();
             // Không xóa User nếu CustomerPoint bị xóa
            // Cấu hình CustomerPoint
            modelBuilder.Entity<CustomerPoint>()
                .Property(cp => cp.UserId)
                .IsRequired();

            modelBuilder.Entity<CustomerPoint>()
                .Property(cp => cp.Points)
                .IsRequired();

            modelBuilder.Entity<CustomerPoint>()
                .Property(cp => cp.OrderId)
                .IsRequired();

            modelBuilder.Entity<CustomerPoint>()
                .Property(cp => cp.EarnedDate)
                .IsRequired();

            // Cấu hình PromotionCode
